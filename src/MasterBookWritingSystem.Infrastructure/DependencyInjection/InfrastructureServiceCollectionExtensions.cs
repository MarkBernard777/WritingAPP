...
public static class InfrastructureServiceCollectionExtensions
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services)
    {
        ...
        services.AddSingleton<ITextFileIO, FileSystemTextFileIO>();
        ...
        services.AddSingleton<IManuscriptSearchReplaceService, ManuscriptSearchReplaceService>();
        services.AddSingleton<IManuscriptVersionService, ManuscriptVersionService>();
        services.AddSingleton<IChapterStructureService, ChapterStructureService>();
